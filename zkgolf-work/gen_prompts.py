...
WORKQUEUE={
 ...
 "secp256k1-scalar-mul": (308278, None, [
  ...
  ("1488 — SAFEST WORK ON THE BOARD, AND IT REPLACES THREE DELETED ITEMS","TWO BOUND PATTERNS ON THE FOLDS. (a) "
   ...
   "2^Wf * 2^192 < p). The GVXHyps side conditions check arithmetically, worst case Fold32 at gf_0 = 6 giving about "
   "2^238 against 2^254, BUT THAT WAS CHECKED IN PYTHON, NOT LEAN — the `by decide` on the third condition is where "
   "it fails if it fails. (b) A PROVABLY ZERO CONVOLUTION CELL, -248, NO SOUNDNESS OBLIGATION: interpolatedMul is "
