...
WORKQUEUE={
 "secp256k1-fixed-base-scalar-mul": (47435, 34030, [
  ("0 — THE -1 AT 47,413 IS SETTLED NEGATIVE, 0-FOR-2, AND THE SITE IS NAMED","*** DO NOT READ THIS AS "
   ...
   "08:50:30Z judged 09:08:24Z, both status=failed score=null after 13 and 18 minutes of verification. The "
   ...
   "sorry, computableWitness present throughout. *** THE STRONGEST SIGNAL PREDATES BOTH JOBS: ll_effNT IS ALREADY "
   "DEFINED IN THE TREE AT ChainFoldCW.lean:54 AND IS UNUSED. *** An earlier job staged the NoTop lemma for this "
   "exact site and declined to flip it. A pre-staged, deliberately-unused variant sitting beside a live one is a "
   "warning marker, not an invitation. IF YOU TRY A THIRD TIME, the thing to establish first is what the deleted "
   "top row supplies at stageO2 that it does not supply where NoTop already works — show the fold's quotient "
   "bound SURVIVES WITHOUT THE ROW, not that the row is redundant GIVEN the affine quotient. An identity true by "
