...
WORKQUEUE={
 ...
 "sha256-hash": (144985, None, [
  ("survival first — BUT WE HAVE NOW BANKED ONE, AND IT SETTLES THE WALL QUESTION","*** THE FULL SUBMISSION LEDGER ON THIS SLUG, AND IT SETTLES THE WALL QUESTION AGAINST THE OBVIOUS READING. -612 TIMED OUT. -306 TIMED OUT. -298 VERIFIED AND TOOK THE RECORD (144,687, from yash1io's 144,985). -280 FAILED. READ THAT ORDER AGAIN: the SECOND SMALLEST reduction we have ever attempted here failed, and a LARGER one verified. Size does not predict the outcome, so AIMING SMALLER IS NOT A STRATEGY and has now cost us three attempts. What survives is a change whose PROOF OBLIGATIONS are cheap. Before you pick a target, ask what it forces the elaborator to re-check, not how many rows it removes. *** BUY ELABORATION HEADROOM BEFORE YOU REDUCE ANY "
