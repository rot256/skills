...
WORKQUEUE={
 ...
 ("928 — A PURE DUPLICATION THE CIRCUIT IS PAYING FOR TWICE","DELETE BOTH Canonicalize.main CALLS AND REUSE THE "
  ...
  ("11115 — THE BIG ONE, ATTEMPT AFTER THE BASE-2^32 WORK LANDS","THE SQUARES TELESCOPE: STOP MATERIALISING THE "
   ...
   "direct generalisation of InterpMul.lean whose Vandermonde machinery is already present. DO NOT RE-SWEEP THE WINDOW WIDTH — w = 12 IS STABLE. An earlier note here said it moves to "
   "10 once the per-addition cost falls; that was re-derived with a select model calibrated to reproduce the live "
   "257 exactly and it is WRONG. At 1,141 per addition: w=10 gives 34,557, w=11 gives 34,499, w=12 gives 32,732, "
   "w=13 gives 35,599. w=12 wins by about 1,770, and it still wins with 8-limb selects and with the rank-2 "
   "pairing applied."),
