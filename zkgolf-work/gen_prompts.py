...
WORKQUEUE={
 ...
 "sha256-hash": (144985, None, [
  ...
  ("2062 upper bound, expect a few hundred — THE ONE BLOCK IN THE TREE WHOSE ROWS ARE UNEXPLAINED","RUN THE "
   ...
   "generated ones, and a 2062-row all-assertion predicate is the second kind. "
