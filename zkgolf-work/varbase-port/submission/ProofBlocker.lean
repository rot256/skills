...
theorem eq_zero_of_nsmul_eq_zero
    (horder : order • gPoint = 0) {a : ℕ} (ha : ¬ order ∣ a)
    {Q : Bridge.W.Point} (hQ : a • Q = 0) : Q = 0 := by
  apply nsmul_right_injective_of_not_order_dvd horder ha
  simpa using hQ

end Solution.Secp256k1ScalarMul.ProofBlocker

#print axioms Solution.Secp256k1ScalarMul.ProofBlocker.point_card_le
#print axioms Solution.Secp256k1ScalarMul.ProofBlocker.noOrderTwo
#print axioms Solution.Secp256k1ScalarMul.ProofBlocker.two_not_dvd_point_card
#print axioms Solution.Secp256k1ScalarMul.ProofBlocker.order_prime
#print axioms Solution.Secp256k1ScalarMul.ProofBlocker.point_card_eq_order_of_order_nsmul
#print axioms Solution.Secp256k1ScalarMul.ProofBlocker.order_nsmul_all
#print axioms Solution.Secp256k1ScalarMul.ProofBlocker.exists_zsmul_gPoint
#print axioms Solution.Secp256k1ScalarMul.ProofBlocker.eq_zero_of_nsmul_eq_zero
