...
theorem beta_modPow : modPow (p - 7) p ((p - 1) / 3) = betaNat := by decide

theorem beta_character : ((-7 : Fp) ^ ((p - 1) / 3)) = (betaNat : Fp) := by
...
#print axioms CheckFastPow.cast_modPow
#print axioms CheckFastPow.beta_modPow
#print axioms CheckFastPow.beta_character
#print axioms CheckFastPow.beta_character_ne_one
