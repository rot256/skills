...
private theorem affineW_sevenMask (e : Expression (F circomPrime)) (he : Affine e) :
    AffineW (PointValid.sevenMask e) := by
  intro i hi
  have hi4 : i < 4 := hi
  rw [PointValid.sevenMask, Vector.getElem_ofFn]
  split
  · exact Affine.mul_deg0 (Affine.sub (Affine.const 1) he) (degree_const _)
  · exact Affine.zero
