...
def main (b : Var Bases (F circomPrime)) : Circuit (F circomPrime) (Var RawTable (F circomPrime)) := do
  ...
  return RawTable.mk e0 e1 e2 e3 e4 e5 e6 e7 e8 e9 e10 e11 e12 e13 e14 e15
